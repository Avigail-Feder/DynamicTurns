...
public class DB {
	...
	public static BooleanResponse isExistUser(String password, String first, String last) {
		return new BooleanResponse(
				users.stream().filter(item -> item.getPassword().equals(password) && item.getFirst_name().equals(first)
						&& item.getLast_name().equals(last)).findAny().orElse(null) != null);
	}
	...
	// -----------static----------------------------------
	static {
		users.add(new User("Nava", "Eisenstein", "0583227457", "p.t", "11", "n0583227457@gmail.com", "1", true, 0));
		users.add(new User("1", "1", "1", "p.t", "1", "n0583227457@gmail.com", "1", false, 1));
		users.add(
				new User("Avigail", "Feder", "0548494053", "PT", "315163659", "a0548494053@gmail.com", "1", false, 2));
		users.add(new User("Michal", "Feder", "0548415655", "PT", "322653023", "m0548415655@gmail.com", "1", false, 3));
		users.add(new User("2", "2", "2", "pt", "2", "mail", "2", false, 4));
